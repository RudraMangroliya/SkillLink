        ...
        {status === "success" ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button 
              ...
              className="w-full bg-indigo-600 text-white font-semibold py-3 rounded-lg hover:bg-indigo-700 transition shadow-md disabled:opacity-70 flex justify-center items-center mt-2 disabled:cursor-not-allowed"
            >
              {timeLeft <= 0 ? "OTP Expired" : status === "loading" ? "Resetting..." : "Reset Password"}
            </button>
